  ...
  function ($) {
    ...
    function initHtml(pagination) {
      ...
      buttons.forEach(function (button) {
        html +=
          '<li class="page ${disabled} ${active}" data-page="${page}"><a class=""  type="button" href="javascript:void(0);">${text}</a></li>'
    ...
    function getButtons(pagination) {
      ...
      let totalPage = option.pageCount;
      ...
      for (var index = 0; index < pageButtonCount; index++) {
        ...
        buttons.push($.extend({}, btn, {
          page, disabled: page == option.selectedIndex,
